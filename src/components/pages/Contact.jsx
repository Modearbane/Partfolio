  ...
  return (
    <div className={`contact-container ${darkMode ? "dark-mode" : ""}`}>
      ...
      <div className="contact-info">
        {/* Pataisytas el. pašto nuorodos formatas */}
        ...
        <a href="https://www.linkedin.com/in/modestas-streleckis-81a708354/" target="_blank" rel="noopener noreferrer" className="contact-item">
          <FaLinkedin className="icon" /> LinkedIn
        </a>
        <a href="https://www.facebook.com/modestas.streleckis" target="_blank" rel="noopener noreferrer" className="contact-item">
